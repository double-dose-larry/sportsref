...
def get_players():
    player_db_url = "https://d395i9ljze9h3x.cloudfront.net/short/inc/players_search_list.csv" # This is what baseball-reference puts in the browser to make their player search fast
...
def get_frans():
    url = "https://d395i9ljze9h3x.cloudfront.net/short/inc/teams_search_list.csv"
    df = (pd.read_csv(url,
